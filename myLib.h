...
#define REG_ISR_MAIN *(void (**)())0x3007FFC
...
#define NUM_ASTEROIDS 70
#define NUM_BULLETS 5
#define NUM_ROTATIONS 8
#define ATTR0_Y 0xFF
#define ATTR1_X 0x1FF
#define AFFINE_ID(x) ((x) << 9)
...
extern ObjAttr spriteBuffer[NUM_SPRITES];
...
void update_pos(Position*);
void spawn_asteroids(Position*, int, int, int);
int dist_sq(Position*, Position*);
int asteroid_radius(Asteroid*);
